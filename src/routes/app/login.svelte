...
<div class="flex items-center justify-center h-screen w-full">
  <main class="bg-purple p-4 text-pink rounded-md max-w-xs w-full">
    ...
    />
    <button
      class="border-2 mt-6 w-full flex items-center text-pink rounded p-2 font-display hover:bg-purple-lighter transition-all"
    ...
    <a class="block ms-2 mt-6 underline font-sans cursor-pointer " href="/app/sign-up">
      {$_("login.signUp")}
    </a>
  </main>
</div>
